...
class QRKembali extends Component {
  constructor(props) {
    super(props);
    this.state = {
      nim: '',
    ...
    AsyncStorage.getItem('@idPinjam', (error, result) => {
      if (result) {
        ...
        alert('idPinjam tidak ditemukan, silahkan untuk pilih ulang');
        this.setState({
          idPinjam: '',
        });
        this.props.navigation.navigate('Home');
  ...
  render() {
    ...
    const push = () => {
      this.pushNotif(
        ...
        `Terima kasih telah mengembalikan buku ${this.state.namaBuku}, Silahkan untuk meminjam buku lainnya!`,
      );
    };
    ...
    return (
      <View style={styles.container}>
        ...
        <Text style={styles.titleTop}>
          Silahkan Scan QR Dibawah ini untuk mengembalikan buku.
        </Text>
        ...
        <ScrollView style={styles.scroll}>
          ...
          <View style={styles.list}>
            <Text>4. </Text>
            <Text style={styles.desc}>
              Terima kasih telah mengembalikan buku, silahkan meminjam buku
              lainnya.
            </Text>
          </View>
        </ScrollView>
