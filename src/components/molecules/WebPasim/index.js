...
const WebPasim = ({onPress}, image, title, desc) => {
  return (
    <View style={{paddingTop: 16, paddingHorizontal: 16}}>
      <View>
        <Image
          source={require('../../../assets/images/dummy/webpasim.jpg')}
      ...
      <View
        ...
        <Text
          ...
          Kunjungi juga web resmi universitas nasional pasim untuk informasi
