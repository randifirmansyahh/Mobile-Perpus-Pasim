...
const WebPub = ({onPress}, image, title, desc) => {
  return (
    <View style={{paddingTop: 16, paddingHorizontal: 16}}>
      <View>
        <Image
          source={require('../../../assets/images/dummy/webpub.jpg')}
      ...
      <View
        ...
        <Text
          ...
          Kunjungi juga web resmi beasiswa pemberdayaan umat berkelanjutan (PUB)
